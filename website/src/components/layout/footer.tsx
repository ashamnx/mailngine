  ...
  return (
    <footer class="hm-footer">
      <div class="hm-footer__inner">
        {/* Link Columns */}
        <div class="hm-footer__columns">
          {FOOTER_COLUMNS.map((column) => (
            <div key={column.title} class="hm-footer__column">
              <h4 class="hm-footer__column-title">{column.title}</h4>
              <ul class="hm-footer__list">
                {column.links.map((link) => (
                  <li key={link.href}>
                    <a href={link.href} class="hm-footer__link">
                      {link.label}
                    </a>
                  </li>
                ))}
